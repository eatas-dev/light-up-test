...
#     )
#     mock_vector_store.as_retriever.return_value.ainvoke = AsyncMock(return_value=[
#                                                                     mock_document])
...
#     mock_mongo_document = {
#         "textContent": mock_document.page_content, "metadata": {"source": "test"}}
#     mock_data_collection = MagicMock()
#     mock_data_collection.find = MagicMock()
#     mock_data_collection.find.return_value.limit = MagicMock(
#         return_value=[mock_mongo_document])

#     # type: ignore [abstract]
#     return ApproachesBase(mock_vector_store, mock_embedding, mock_chat, mock_data_collection)
...
#     _mock = MagicMock()
#     monkeypatch.setattr(quartapp.approaches.setup,
#                         quartapp.approaches.setup.setup_data_collection.__name__, _mock)
#     return _mock
...
#         openai.resources.AsyncEmbeddings, "create", mock_acreate)
...
#     monkeypatch_session.setattr(
#         openai.resources.chat.completions.AsyncCompletions, "create", mock_acreate)
